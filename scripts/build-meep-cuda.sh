...
for tool in autoreconf c++ make nvcc; do
...
BUILD_DIR="${REPO_ROOT}/build/meep-cuda-fp32"
INSTALL_DIR="${REPO_ROOT}/install/meep-cuda-fp32"
...
echo "CUDA-enabled Meep FP32 installed in ${INSTALL_DIR}"
