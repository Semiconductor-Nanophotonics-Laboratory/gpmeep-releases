...
if __name__ == "__main__":
    ...
    # Retain both polarizations as machine-readable numerical results for the
    # CPU/strict-CUDA example oracle while preserving the tutorial's stdout.
    meep_reflection_coefficients = []
    ...
    for pol, theta, L in zip(pols, thetas, Ls):
        ...
        meep_reflection_coefficients.append(R_meep)
        fresnel_reflection_coefficients.append(R_fres)
        ...
        magnitude_relative_errors.append(err_mag)
        print(
        ...
        phase_relative_errors.append(err_phase)
        print(
